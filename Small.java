...
class Small extends JFrame implements ActionListener{
	...
	for(int i=0;i<28;i++)
	{
		char tempa=(char)(97+i);
		String imageName="Small/"+String.valueOf(tempa)+".jpg";
